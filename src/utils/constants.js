export const weatherOptions = [
  ...
  },
  {
    day: true,
    condition: "cloudy",
    url: new URL("../assets/day_cloudy", import.meta.url).href,
  },
  {
    day: true,
    condition: "fog",
    url: new URL("../assets/day_fog.png", import.meta.url).href,
  },
  {
    day: true,
    condition: "rain",
    url: new URL("../assets/day_rain.png", import.meta.url).href,
  },
  {
    day: true,
    condition: "snow",
    url: new URL("../assets/day_snow.png", import.meta.url).href,
  },
  {
    day: true,
    condition: "storm",
    url: new URL("../assets/day_storm.png", import.meta.url).href,
  },
  {
    day: false,
    condition: "clear",
  ...
  },
  {
    day: false,
    condition: "cloudy",
    url: new URL("../assets/night_cloudy", import.meta.url).href,
  },
  {
    day: false,
    condition: "fog",
...
export const coordinates = {
  latitude: 21.350559,
  longitude: -158.088867,
};

export const APIkey = "7d754699326a3d676bccd6cfe853d3fb";
